...
const banner = cfonts.render((`© 2024 sandro bot`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});

const banner2 = cfonts.render((`© 2024 sandro bot \nsandro bot versao 8.0.0 especial`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`SANDRO|BOT`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const chyt = "556596947474@s.whatsapp.net";
const nit = "556593065507@s.whatsapp.net";
...
module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, banner2, banner, temporizador, color, recognize, bgcolor, isFiltered, addFilter, banner3, chyt, getExtension, convertSticker, upload, nit, getpc, supre }
